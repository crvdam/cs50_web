# Generated by Django 4.1.5 on 2023-09-19 13:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Animals', 'Animals'), ('Books', 'Books'), ('Cars', 'Cars'), ('Fruit', 'Fruit')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment', models.CharField(default='', max_length=64)),
